...
#' @return Small multiple charts depicting building elevations and a print-out of the number of potential combinations in the console
#' @examples
#' elevations(nbuildings = 6, min_storey = 4, max_storey = 5)
#' @export

elevations = function(nbuildings, min_storey, max_storey) {
