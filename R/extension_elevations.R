...
#' @return Multiple bar charts depicting potential rooftop extension elevations ordered by density as well as a print-out of the number of potential combinations in the console
#' @examples
#' # Visualise potentials based on the maximum number of storeys per extension
#' storeys_i = c(3, 3, 4)
#' extension_elevations(storeys = storeys_i, max_permitted_extstorey = 2)
#' 
#' # Chart potential extensions using the maximum number of storeys per building
#' storeys_ii = c(3, 2, 2, 3, 4)
#' extension_elevations(storeys = storeys_ii, max_permitted_storey = 4)
#' @export

extension_elevations = function(storeys = NULL, df = NULL, max_permitted_storey = NULL, max_permitted_extstorey = NULL) {
